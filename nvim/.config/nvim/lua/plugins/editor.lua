return {
    -- Harpoon for quick file navigation
    {
        ...
        config = function()
            ...
            vim.keymap.set("n", "<leader>h", function() ui.nav_file(1) end, { desc = "Harpoon file 1" })
            vim.keymap.set("n", "<leader>j", function() ui.nav_file(2) end, { desc = "Harpoon file 2" })
            vim.keymap.set("n", "<leader>k", function() ui.nav_file(3) end, { desc = "Harpoon file 3" })
            vim.keymap.set("n", "<leader>l", function() ui.nav_file(4) end, { desc = "Harpoon file 4" })
        end,
    },
